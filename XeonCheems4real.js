...
dataa = await fetchJson(`https://api.countapi.xyz/hit/CheemsBot${moment.tz('Asia/Makassar').format('DDMMYYYY')}/visits`)
...
case 'tiktok2':{
   ...
   let buttons = [
      {buttonId: `ttwm2 ${q}`, buttonText: {displayText: 'With Watermark '}, type: 1},
      {buttonId: `ttnowm2 ${q}`, buttonText: {displayText: 'No Watermark '}, type: 1},
...
case 'tiktok': {
    ...
    let buttons = [
    {buttonId: `ttnowm ${q}`, buttonText: {displayText: 'Video'}, type: 1},
