...
/*
https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/d460e086f9f9bf6b04e17.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}

https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://telegra.ph/file/d460e086f9f9bf6b04e17.jpg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}

https://api-neobot.herokuapp.com/api/maker/welcome1?name=${encodeURIComponent(nama)}&gpname=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}&pp=${encodeURIComponent(ppuser)}&bg=https://cdn.discordapp.com/attachments/997472908085567548/997508987031408782/images_55.jpeg

https://api-neobot.herokuapp.com/api/maker/goodbye1?name=${encodeURIComponent(nama)}&gpname=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}&pp=${encodeURIComponent(ppuser)}&bg=https://cdn.discordapp.com/attachments/997472908085567548/997508987031408782/images_55.jpeg
*/
