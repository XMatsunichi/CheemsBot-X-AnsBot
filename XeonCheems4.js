...
"ptt": "true"
	...
	//group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/ans.png`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
if (q.includes('--help')) return reply(examkosong) 
 ...
 break
 case prefix+'hunt': case prefix+'hunting': {
 	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (q.includes('--help')) return reply(examkosong) 
 if (!isDarah){ addInventoriDarah(m.sender, DarahAwal) }
...
let resul = anu[Math.floor(Math.random() * anu.length)]
let msg = await XeonBotInc.sendMessage(m.chat, { audio: { url: resul.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
XeonBotInc.sendText(m.chat, `What is the name of this song?\n\nArtist : ${resul.artist}\nTime : 60s`, msg).then(() => {
tebaklagu[m.sender.split('@')[0]] = resul.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + resul.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess song', buttonText: { displayText: 'Guess the song' }, type: 1 }], `Time has run out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklagu[m.sender.split('@')[0]]
}
...
let resul = anu[Math.floor(Math.random() * anu.length)]
XeonBotInc.sendImage(m.chat, resul.img, `Please answer the question above\n\nDescription : ${resul.deskripsi}\nTime : 60s`, m).then(() => {
tebakgambar[m.sender.split('@')[0]] = resul.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess picture', buttonText: { displayText: 'Guess the picture' }, type: 1 }], `Time has run out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant to play? press the button below`,`${global.botname}`, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'word') {
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkata[m.sender.split('@')[0]]
}
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess sentence', buttonText: { displayText: 'Guess the Sentence' }, type: 1 }], `Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete tebaklirik[m.sender.split('@')[0]]
}
...
console.log("Answer: " + result.jawaban)
XeonBotInc.sendButtonText(m.chat, [{ buttonId: prefix+'guess saying', buttonText: { displayText: 'Guess The Saying' }, type: 1 }], `Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\nWant to play? press the button below`, `${global.botname}`, m)
delete caklontong[m.sender.split('@')[0]]
delete caklontong_desk[m.sender.split('@')[0]]
}
}
...
XeonBotInc.sendMessage(from, { text: `Question : apakah ${q}\nAnswer : ${kah}` }, { quoted: m })

					break
					            case prefix+'mungkinkah':
					if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
				if (!text) return replay(`Use Text, Example : ${prefix + command} he married `)
					const lel = [`Ask Your Gf`, `I Dont Know`, `I Don't Know, Ask Your Father`]
					const kahk = lel[Math.floor(Math.random() * lel.length)]
XeonBotInc.sendMessage(from, { text: `Question : mungkinkah ${q}\nAnswer : ${kahk}` }, { quoted: m })
...
XeonBotInc.sendMessage(from, { text: `Question : bisakah ${q}\nAnswer : ${ga}` }, { quoted: m })

					break
case prefix+'bagaimana':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
				if (!text) return replay(`Use Text, Example : ${prefix + command} is my face`)
					const gimana = [`It's Okay`, `It's Difficult Bro`, `Sorry Bot Can't Answer`, `Try Searching On Google`,`Holy Cow! Really???`,`Dizzy Ah`,`Ohhh I See:(`,`The Patient, Boss:(`,`How Are You?`]
					const ya = gimana[Math.floor(Math.random() * gimana.length)]
XeonBotInc.sendMessage(from, { text: `Question : bagaimana ${q}\nAnswer : How ${ya}` }, { quoted: m })
...
if (isBanChat) return reply(mess.banChat)
					...
					XeonBotInc.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
                    case prefix+'awesomecheck':
  case prefix+'greatcheck':
    case prefix+'gaycheck':
      case prefix+'cutecheck':
        case prefix+'lesbicheck':
          case prefix+'lesbiancheck':
             case prefix+'hornycheck':
                 case prefix+'prettycheck':
                    case prefix+'lovelycheck':
                      case prefix+'uglycheck':
                                  	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @Xeon`)
...
XeonBotInc.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
      ...
      case prefix+'randi':
      case prefix+'gandu':
      case prefix+'madarchod':
      case prefix+'kala':
      case prefix+'gora':
      case prefix+'chutiya':
      case prefix+'nibba':
      case prefix+'nibbi':
      case prefix+'bhosdiwala':
      case prefix+'chutmarika':
      case prefix+'bokachoda':
      case prefix+'suarerbaccha':
      case prefix+'bolochoda':
      case prefix+'muthal':
      case prefix+'muthbaaz':
      case prefix+'randibaaz':
      case prefix+'topibaaz':
      case prefix+'cunt':
      case prefix+'nerd':
      case prefix+'behenchod':
      case prefix+'behnchoda':
      case prefix+'bhosdika':
      case prefix+'nerd':
      case prefix+'mc':
      case prefix+'bsdk':
      case prefix+'bhosdk':
      ...
      case prefix+'dumbass':
      case prefix+'sexy':
      case prefix+'crackhead':
      case prefix+'mf':
      case prefix+'motherfucker':
      case prefix+'dogla':
      case prefix+'bewda':
      case prefix+'boka':
      case prefix+'khanki':
...
case 'assalamualaikum':
{
XeonBotInc.sendMessage(m.chat, {text: ` *${pushname}* وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ \n\n Waalaikumussalam Warahmatullahi Wabarakatuh`}, {quoted:m})
}
break
...
XeonBotInc.sendMessage(from, { text: `Question : kapankah ${q}\nAnswer : *${kapankah}*` }, { quoted: m })
					break
case prefix+'wangy':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (!isCreator) return replay(mess.owner)
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "916909137213-1604595598@g.us"}, "message": {orderMessage: {itemCount: 999999999,status: 200, thumbnail: fs.readFileSync('./XeonMedia/theme/ans.png'), surface: 200, message: `${ownername}'s Broadcast`, orderTitle: `${botname}`, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://xteam.xyz/attp2?file&text=${text}`, 'hisoka', 'morou', m, {asSticker: true})
...
if (isBanChat) return reply(mess.banChat)
           ...
           await XeonBotInc.sendMedia(m.chat, `https://api.lolhuman.xyz/api/attp2?apikey=b7fa05fd87b7c3e3147d8622&text=${text}`, 'Xeon', 'Op', m, {asSticker: true}).catch((err) => reply(mess.error))
         }
         break
case prefix+'ttp': {
if (isBan) return reply(mess.ban)	 			
...
case prefix+'dogee':{
    if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
   let stik = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/doge?apikey=V12`)
   encmedia = await XeonBotInc.sendImageAsSticker(from, stik, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
case prefix+'meoww':{
    if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
   let stik = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/meow?apikey=V12`)
   encmedia = await XeonBotInc.sendImageAsSticker(from, stik, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
case prefix+'patrickk':{
    if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
   let stik = await getBuffer(`https://api.zeeoneofc.xyz/api/telegram-sticker/patrick?apikey=V12`)
   encmedia = await XeonBotInc.sendImageAsSticker(from, stik, m, { packname: global.packname, author: global.author, })
await fs.unlinkSync(encmedia)
}
break
...
break
/*case prefix+'wallneon': case prefix+'wallrandom': case prefix+'wallcode': case prefix+'wallpubg': case prefix+'wallml': 	
{
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
reply(mess.wait)						
...
break
case prefix+'blowjobgif': case prefix+'bj' :
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
if (!AntiNsfw) return reply(mess.nsfw)
...
break
case prefix+'hentaivid': case prefix+'hentaivideo': {
	                        	            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
	if (!m.isGroup) return replay(mess.group)
if (!AntiNsfw) return reply(mess.nsfw)
...
reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/pat`)
                           var wbuttsss = [
        {buttonId: prefix+`animepat`, buttonText: {displayText: `Next ✨`}, type: 1},
        ]
...
break
case prefix+'translate': case prefix+'trans': {
if (isBan) return reply(mess.ban)
...
emote(q, "8")
break
case prefix+'mojiemoji': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply("Enter emoji, max 1 emoji, eg?" + ` ${prefix + command} 😀`)
reply(mess.wait)
emote(q, "9")
case prefix+'pediaemoji': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply("Enter emoji, max 1 emoji, eg?" + ` ${prefix + command} 😀`)
reply(mess.wait)
...
break
	case prefix+'igstoryxx': case prefix+'instagramstoryxx': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
break
case prefix+'igs2': case prefix+'igstory2': case prefix+'instagramstory2': {
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
			...
			break
case prefix+'ig2': case prefix+'igdl2': case prefix+'instagram2': {
               if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
			...
			break
case prefix+'igdl': case prefix+'instagram': case prefix+'instagramreels': case prefix+'igreels': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)	             
            ...
            break
case prefix+'twitterxx': case prefix+'twdlxx': case prefix+'twmp4xx': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
break
case prefix+'fbdl': case prefix+'fb': case prefix+'facebook': case prefix+'fbmp4': {     	    
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
  ...
  XeonBotInc.sendMessage(m.chat, { audio: { url: anu.url[0].url }, mimetype: 'audio/mp4' }, { quoted: m })      
            ...
            break
case prefix+'facebookxx': case prefix+'fbdlxxx': case prefix+'fbmp4xxx': case prefix+'fbxxx': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
		...
		let { pinterest } = require('./lib/scraper')
                ...
                XeonBotInc.sendMessage(m.chat, { image: { url: resul }, caption: '🌚 Media Url : '+resul }, { quoted: m })
            }
            break
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            break
case prefix+'apk': case prefix+'apkmod': case prefix+'apkdl': {      
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
            ...
            break
            case prefix+'characterxxx': case prefix+'karakterxxx':
               if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
XeonBotInc.sendMessage(from, {text : `case prefix+: ${kasus}\n\nDead : ${kematian}\n\nHealed : ${sembuh}`}, m)
break
case prefix+'tvschedule':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply('Send orders *#tvschedule [channel]*')
reply(await jadwaltv(q))
break
case prefix+'playstore': case prefix+'apk':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
case prefix+'image': {
	...
	if (isBanChat) return reply(mess.banChat)
		...
		let { pinterest } = require('./lib/scraperW')
                anu = await pinterest(text)
                resul = anu[Math.floor(Math.random() * anu.length)]
                XeonBotInc.sendMessage(m.chat, { image: { url: resul }, caption: ` ${themeemoji} Media Url : `+resul }, { quoted: m })
            }
            break
...
break
case prefix+'islamicshortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let cerpe = await cerpen(`Cinta segitiga`)
        reply(`${themeemoji} _*Title :*_ ${cerpe.title}\n${themeemoji} _*Author :*_ ${cerpe.author}\n${themeemoji} _*Category :*_ ${cerpe.kategori}\n${themeemoji} _*Pass Moderation :*_ ${cerpe.lolos}\n${themeemoji} _*Story :*_\n${cerpe.cerita}`)
...
break
case prefix+'disturbingshorystoryx':{
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
break
case prefix+'friendshipshortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
break
case prefix+'sacrificeshortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
		...
		let buttons = [
                ...
                let buttonMessage = {
                    image: { url: resul.image[0] },
                    caption: `Title : ${resul.title}\nCategory : ${resul.type}\nDetail : ${resul.source}\nMedia Url : ${resul.image[2] || resul.image[1] || resul.image[0]}`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            case prefix+'simi':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                let sim = await fetchJson(`https://api-ans.up.railway.app/api/fun/simisimi-ind2?text=${text}&apikey=APIKEY`)
                reply(`${sim.result.success}`)
            }
            break

            case prefix+'wallanjing':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallanjing`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/anjing?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
            case prefix+'wallkucing':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallkucing`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/kucing?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallanime':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallanime`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/anime?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallaesthetic':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallaesthetic`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/aesthetic?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallpubg':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallpubg`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/pubg?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallhekel':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallhekel`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/hekel?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallkpop':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallkpop`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/kpop?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'walldoraemon':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `walldoraemon`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/doraemon?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallblackpink':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallblackpink`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/random/blackpink?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'walljustina':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `walljustina`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/justina?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallryujin':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallryujin`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/ryujin?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallprograming':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallprograming`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/programing?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallislami':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallislami`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/islami?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallrose':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallrose`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/rose?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallmountain':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallmountain`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/mountain?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallgaming':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallgaming`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/gaming?apikey=APIKEY' },
                    caption: `Done Gaming!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallcyberspace':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallcyberspace`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/cyberspace?apikey=APIKEY' },
                    caption: `Done ${command}`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            case prefix+'wallplanet':{
                ...
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallplanet`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/tatasurya?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallcartoon':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallcartoon`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/kartun?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'wallpentol':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `wallpentol`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/pentol?apikey=APIKEY' },
                    caption: `Done ${command}`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'walljisoo':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `walljisoo`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/jiso?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
            ...
            break
            case prefix+'walljeni':{
                if (isBan) return reply(mess.ban)	 			
                if (isBanChat) return reply(mess.banChat)
                reply(mess.wait)
                let buttons = [
                    {buttonId: `walljeni`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api-ans.up.railway.app/api/wallpaper/jeni?apikey=APIKEY' },
                    caption: `Done ${command}!`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
...
break
	...
	if (isBanChat) return reply(mess.banChat)
		...
		let { wikimedia } = require('./lib/scraper')
            ...
            break
            case prefix+'quotesanime': case prefix+'animequotes': case prefix+'animequote': case prefix+'quoteanime': {
            	 	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            break
            case prefix+'ramalannasib': case prefix+'ramalnasib':  {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
case prefix+'tiktok':{
   ...
   let buttons = [
      ...
      let buttonMessage = {
         image: {url: anu.result.download.thumb},
         caption: `//==TIKTOK DOWNLOADER==//
🌚 *Name* : ${anu.result.author.name}
🌚 *Username* : ${anu.result.author.username}
🌚 *Description* : ${anu.result.title}
🌚 *Views* : ${anu.result.videos.views}
🌚 *Likes* : ${anu.result.videos.likes}
🌚 *Comment* : ${anu.result.videos.comment}
🌚 *Share* : ${anu.result.videos.share}
🌚 *Sound* : ${anu.result.videos.sound}`,
         footer: `${botname}`,
         buttons: buttons,
         headerType: 4,
         contextInfo:{externalAdReply:{
...
case prefix+'ttwm':{
   ...
   if (!q.includes('tiktok')) return reply(`That's not a tiktok link!`)
   let anu = await fetchJson(`https://fatiharridho.herokuapp.com/api/downloader/tiktok?url=${text}`)
   XeonBotInc.sendMessage(from, { video: { url: anu.result.download.with_wm }, caption: "Here you go!" }, { quoted: m })
}
break
case prefix+'ttnowm':{
   if (isBan) return reply(mess.ban)
   ...
   if (!q.includes('tiktok')) return reply(`That's not a tiktok link!`)
   let anu = await fetchJson(`https://fatiharridho.herokuapp.com/api/downloader/tiktok?url=${text}`)
   XeonBotInc.sendMessage(from, { video: { url: anu.result.download.no_wm }, caption: "Here you go!" }, { quoted: m })
}
break
case prefix+'ttaud':{
   if (isBan) return reply(mess.ban)
   ...
   if (!q.includes('tiktok')) return reply(`That's not a tiktok link!`)
   let anu = await fetchJson(`https://fatiharridho.herokuapp.com/api/downloader/tiktok?url=${text}`)
   XeonBotInc.sendMessage(from, { audio: { url: anu.result.download.music }, mimetype: 'audio/mp4' }, { quoted: m })
}
break		
...
case prefix+'tiktok2': {
    ...
    let buttons = [
    {buttonId: `.ttnowm2 ${q}`, buttonText: {displayText: 'Video'}, type: 1},
    {buttonId: `.ttaud2 ${q}`, buttonText: {displayText: 'Audio'}, type: 1}
    ]
    let buttonMessage = {
...
case prefix+'ttnowm2':{
  ...
  reply(mess.wait)
  let res = await tiktok(q)
  XeonBotInc.sendMessage(from, { video: { url: res.nowm }, caption: "Here you go!" }, { quoted: m } )
}
break
case prefix+'ttaud2':{
    if (isBan) return reply(mess.ban)
  ...
  reply(mess.wait)
  let res = await tiktok(q)
  XeonBotInc.sendMessage(from, { audio: { url: res.audio }, mimetype: 'audio/mp4'}, { quoted: m } )
}
break
...
case prefix+'ttaud':{
 ...
 break*/
	case prefix+'music': case prefix+'play': case prefix+'song': case prefix+'ytplay': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let yts = require("yt-search")
...
break
case prefix+'getmusic': case prefix+'getvideo': case prefix+'yt': case prefix+'youtube': case prefix+'ytvideo': case prefix+'ytmp3': case prefix+'ytmp4': case prefix+'ytmusic': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
break
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            break
case prefix+'ytshorts': case prefix+'shorts': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    ...
                    break
case prefix+'sc': case prefix+'script': case prefix+'donate': case prefix+'donate': case prefix+'cekupdate': case prefix+'updatebot': case prefix+'cekbot': case prefix+'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
thumbnail: fs.readFileSync("XeonMedia/theme/ans.png"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/ae2496b6f6c4f475f4845.jpg',
sourceUrl: "https://telegra.ph/file/ae2496b6f6c4f475f4845.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                                ...
                                quickReplyButton: {
                                    displayText: prefix+'All Menu 🍱',
                                    id: prefix+'allmenu'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: prefix+'List Menu 🍢',
                                    id: prefix+'command'
                                }  
                            }, {
                                quickReplyButton: {
            ...
            { quickReplyButton: { displayText: prefix+`All Menu 🍱`, id: prefix+'allmenu'} },
            { quickReplyButton: { displayText: prefix+`List Menu 🍢`, id: prefix+'command'} },
							...
							},
							{
								...
								"rows": [
									...
									},
									{
                                        ...
                                        {
											"title": "Shortstory Menu 📚",
										"description": "Displays The List Of Shortstory Features",
										"rowId": `${prefix}shortstorymenu`
										}
								]
							},
							{
...
╠ ${prefix}wallanjing
╠ ${prefix}wallpubg
╠ ${prefix}wallprograming
╠ ${prefix}wallgaming
╠ ${prefix}wallhekel
╠ ${prefix}wallcyberspace
╠ ${prefix}wallaesthetic
╠ ${prefix}wallkpop
╠ ${prefix}wallblackpink
╠ ${prefix}wallrose
╠ ${prefix}walljisoo
╠ ${prefix}walljeni
╠ ${prefix}wallryujin
...
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "Instagram 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case prefix+'shortstorymenu':
    if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'Shortstory Menu')
await XeonBotInc.send5ButImg(from, `╔═══════✪「 SHORTSTORY 」
╠ ${prefix}shortstory Anak
╠ ${prefix}shortstory Bahasa Daerah
╠ ${prefix}shortstory Bahasa Inggris
╠ ${prefix}shortstory Bahasa Jawa
